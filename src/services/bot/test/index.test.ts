...
async function runTests() {
  ...
  try {
    console.log("----------------------------------------");
    console.log("🤖 Bot Service Test Suite");
    console.log("----------------------------------------");
    ...
    for (const { module: _module, name } of loadedModules) {
    ...
    console.log("\n----------------------------------------");
    console.log(
      `✅ Bot service test modules loaded: ${passedCount}/${testCount} modules, ${failedCount} failed to load`,
    );
    console.log("----------------------------------------");
