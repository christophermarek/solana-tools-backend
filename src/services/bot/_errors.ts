export const BOT_ERRORS = {
  ...
  ERROR_UNKNOWN_VOLUME_BOT:
    "Unknown error occurred during volume bot execution",
  ERROR_BOT_EXECUTION_NOT_FOUND: "Bot execution not found",
  ERROR_FAILED_TO_GET_TRANSACTIONS: "Failed to get bot execution transactions",
} as const;
